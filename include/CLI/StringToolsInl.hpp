...
#include <type_traits>
#include <vector>
// [CLI11:private_includes:end]


namespace CLI {

// [CLI11:StringToolsInl:verbatim]
...
CLI11_INLINE std::string &trim(std::string &str) { return ltrim(rtrim(str)); }

/// Trim anything from string
CLI11_INLINE std::string &trim(std::string &str, const std::string filter) { return ltrim(rtrim(str, filter), filter); }
